...
public class NonCoPrime {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(subSetCount(arr, 0, arr[0], dp,true));
		} catch (Exception e) {
	...
	public static Long subSetCount(int[] arr,int index,int lastGCD,HashMap<Integer,Long>[] dp,boolean isFirst)
		throws Exception{
		if(index == arr.length){
			return (long)0;
		}
