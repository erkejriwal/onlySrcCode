...
public class FibonacciNosGreatestCommonDivisor {
	//private static int[] fibonacciStorage;
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < q; i++) {
			System.out.println(factorial(st.getSum(n, scanner.nextInt()-1, scanner.nextInt()-1)-1));
		}
	}
